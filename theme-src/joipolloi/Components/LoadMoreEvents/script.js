class LoadMoreEvents extends window.HTMLDivElement {
  constructor (...args) {
...
window.customElements.define('joi-load-more-events', LoadMoreEvents, { extends: 'div' });
