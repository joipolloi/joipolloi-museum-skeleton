...
class BlockExploreCarousel extends window.HTMLDivElement {
  constructor (...args) {
  ...
  initSlider() {
    ...
    setTimeout(() => this.swiper.navigation.update(), 0);
  }
}

window.customElements.define('joi-block-explore-carousel', BlockExploreCarousel, { extends: 'div' });
