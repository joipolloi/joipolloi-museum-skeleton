...
if (Init::checkRequiredPlugins()) {
    ...
    add_action('after_setup_theme', ['Joi\Init', 'initTheme']);
    add_action('after_setup_theme', ['Joi\Init', 'loadComponents'], 101);
}
...
add_action('after_setup_theme', function () {
     ...
     */
    load_theme_textdomain('joi', get_template_directory() . '/languages');
});
