...
class ComponentManager
{
    ...
    public function registerComponent($componentName, $componentPath = null)
    {
        ...
        $componentPath = trailingslashit(apply_filters('Joi/componentPath', $componentPath, $componentName));

        // add component to internal list (array)
        $this->add($componentName, $componentPath);

        do_action('Joi/registerComponent', $componentName);
        do_action("Joi/registerComponent?name={$componentName}", $componentName);
